...
import { createAdminInvite, listPendingInvites, supabase, updateInviteStatus } from "@/lib/supabase";
...
export default function AdminApprovalPanel() {
  const [form, setForm] = useState({ fullName: "", email: "", phone: "", memberId: "" }); const [invites, setInvites] = useState<Invite[]>([]); const [notice, setNotice] = useState(""); const [busy, setBusy] = useState(false); const sendStatusEmail = trpc.notifications.sendMemberStatus.useMutation();
